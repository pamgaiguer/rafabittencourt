...
**NOTE:** Your Twitter account cannot be set to Private.
...
1. For better compatibility with shared server environments, version 2.0 now uses cURL to gather tweets
